...
public class UploadController {
    ...
    public boolean checkInvoiceValueIsNumber(String value) {
        try {
    ...
    public boolean checkInvoiceValueIsPositive(String value) {
        try {
            invoiceValueDouble = Double.parseDouble(value);
    ...
    public void onInvoiceUploadButtonClick() throws IOException, SQLException {
        ...
        if (checkDateInPast(invoiceDate.getValue())) {
            if (checkInvoiceValueIsNumber(invoiceValue.getText())) {
                if (checkInvoiceValueIsPositive(invoiceValue.getText())) {
